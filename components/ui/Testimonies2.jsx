                  ...
                  <Link href="" className="cursor-pointer" legacyBehavior>
                    <div className="relative p-6 space-y-6 leading-none rounded-lg bg-slate-800 ring-1 ring-gray-900/5">
                      <div className="flex items-center space-x-4">
                        <img
                          src="https://lh3.googleusercontent.com/a-/ALV-UjVOC04QdO8UJC0jVG_HbP6ovjnnSwxG3ISGQF_eMoU5d9zS=w36-h36-p-rp-mo-br100"
                      ...
                      <p className="leading-normal text-gray-300 text-md">
                        I highly recommend Zac and his crew at Blue Horizon
                        Roofing and Exteriors. I refer him to all my clients
                        with confidence that they will be treated with respect
                        and have quality work done at a fair price. It’s hard to
                        know who to trust these days but rest assured you can
                        fully trust BLUE HORIZON!
                      </p>
                    </div>
                  </Link>
                </div>
                ...
                <div className="relative group hover:scale-110 ease-in-out duration-300">
                  ...
                  >
                    <div className="relative p-6 space-y-6 leading-none rounded-lg bg-slate-800 ring-1 ring-gray-900/5">
                      <div className="flex items-center space-x-4">
                        <img
                          src="https://lh3.googleusercontent.com/a/ACg8ocJv-oXCy79lupTDIFU_cqvvuaYPKQaJkJii3q6LTfKW=w36-h36-p-rp-mo-br100"
                          className="w-12 h-12 bg-center bg-cover border rounded-full"
                          alt="User Photo"
                        />
                        <div>
                      ...
                      <p className="leading-normal text-gray-300 text-md">
                        Zac is top notch. He is very honest, reliable and
                        dependable. Zac and his crew replaced my roof and did a
                        great job. I highly recommend him and his company.
                      </p>
                    </div>
                  </Link>
                </div>
                ...
                <div className="relative group hover:scale-110 ease-in-out duration-300">
                  ...
                  >
                    <div className="relative p-6 space-y-6 leading-none rounded-lg bg-slate-800 ring-1 ring-gray-900/5">
                      <div className="flex items-center space-x-4">
                        <img
                          src="https://lh3.googleusercontent.com/a-/ALV-UjW8RsoVrDtuScvmcUjccezk3YEML6COJcleDlwvmEYiWA=w36-h36-p-rp-mo-br100"
                          className="w-12 h-12 bg-center bg-cover border rounded-full"
                          alt="User Photo"
                        />
                        <div>
              ...
              <li className="text-sm leading-6">
                <div className="relative group hover:scale-110 ease-in-out duration-300">
                  ...
                  <div className="relative p-6 space-y-6 leading-none rounded-lg bg-slate-800 ring-1 ring-gray-900/5">
                    <div className="flex items-center space-x-4">
                      <img
                        src="https://lh3.googleusercontent.com/a-/ALV-UjXJqwszoKg5fW1tdIM1AQLTmCWf0g4Hj4SGMmtmPdrfrzMk=w36-h36-p-rp-mo-ba3-br100"
                        className="w-12 h-12 bg-center bg-cover border rounded-full"
                        alt="User Photo"
                      />
                      <div>
